Feature: Category Navigation on AutomationExercise
  ...
  Scenario: Verify Kids Tops & Shirts Category
    ...
    Then User should see "TOPS & SHIRTS" category page title